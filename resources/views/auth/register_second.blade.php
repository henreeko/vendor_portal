...
<x-guest-layout>
    <form method="POST" action="{{ route('register.second-store') }}" enctype="multipart/form-data"  class="space-y-6">
        ...
        <div class="mb-6">
            <label for="billing_representative_first_name" class="block text-sm font-medium text-gray-700">Billing Representative<span class="text-red-500">*</label>
            <div class="flex">
        ...
        <div class="space-y-6 bg-white p-6 rounded-md shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-y-2 gap-x-4 sm:grid-cols-3">
                ...
                <div class="sm:col-span-2">
                    <input id="bir_2303" type="file" name="bir_2303" class="block w-full text-sm text-gray-900 file:mr-4 file:py-2 file:px-4 file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" required>
                    <p class="text-blue-500 text-xs mt-2">Set Document Expiry Date:</p>
                    <input type="date" name="bir_2303_expiry" class="mt-2 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
            ...
            <div class="grid grid-cols-1 gap-y-2 gap-x-4 sm:grid-cols-3">
                ...
                <div class="sm:col-span-2">
                    <input id="sec" type="file" name="sec" class="block w-full text-sm text-gray-900 file:mr-4 file:py-2 file:px-4 file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" required>
                    <p class="text-blue-500 text-xs mt-2">Set Document Expiry Date:</p>
                    <input type="date" name="sec_expiry" class="mt-2 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
            ...
            <div class="grid grid-cols-1 gap-y-2 gap-x-4 sm:grid-cols-3">
                ...
                <div class="sm:col-span-2">
                    <input id="mayors_permit" type="file" name="mayors_permit" class="block w-full text-sm text-gray-900 file:mr-4 file:py-2 file:px-4 file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" required>
                    <p class="text-blue-500 text-xs mt-2">Set Document Expiry Date:</p>
                    <input type="date" name="mayors_permit_expiry" class="mt-2 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>

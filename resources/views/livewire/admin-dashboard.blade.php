...
<div class="py-6">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="{{ route('admin.deleted-users') }}" class="bg-white overflow-hidden shadow rounded-lg transition duration-300 ease-in-out hover:-translate-y-1">
            <div class="p-6 flex items-center">
                <div class="flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-red-600">
        ...
        <a href="{{ route('admin.business-types.index') }}" class="bg-white overflow-hidden shadow rounded-lg transition duration-300 ease-in-out hover:-translate-y-1">
            <div class="p-6 flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-xl font-semibold text-gray-900">{{ $count }}</p> <!-- Display the count here -->
                </div>
            </div>
        </a>
    </div>

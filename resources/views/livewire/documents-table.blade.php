        ...
        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tr>
            ...
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
              <a href="{{ Storage::url($document->path) }}" class="text-indigo-600 hover:text-indigo-900 dark:hover:text-indigo-400">View</a>
              <a href="{{ Storage::url($document->path) }}" download="{{ $document->name }}" class="ml-4 text-indigo-600 hover:text-indigo-900 dark:hover:text-indigo-400">Download</a>
            </td>
          </tr>
          @endforeach
        </tbody>
